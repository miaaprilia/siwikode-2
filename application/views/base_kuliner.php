<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <a href="<?php echo base_url('admin/form_kuliner') ?>" class="btn btn-primary">Tambah</a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($wisata as $w) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('admin/Kuliner/detail/') . $w['id_wisata'] ?>" class="btn btn-sm btn-success">Detail</a>
                                        <a href="<?php echo base_url('admin/Kuliner/delete/') . $w['id_wisata'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                    </td>
                                </tr>
