<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <a href="<?php echo base_url('admin/form_testimoni') ?>" class="btn btn-primary">Tambah</a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($testimoni as $t) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('admin/testimoni/detail/') . $t['id'] ?>" class="btn btn-sm btn-success">Detail</a>
                                        <a href="<?php echo base_url('admin/testimoni/delete/') . $t['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                    </td>
                                </tr>
