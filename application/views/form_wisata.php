        ...
        <div id="form-add-list" class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Add Wisata Rekreasi</h6>
                </div>
                <div class="card-body">
                    <form action="<?php echo base_url() ?>admin/wisata/save" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="jenis_wisata_id">
                                    <option value="">Pilih Wisata Rekreasi</option>
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-3 col-form-label">Latlong</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="latlong" name="latlong" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="jenis_wisata_id">
                                    <?php foreach ($get_kuliner as $get_kuliner) { ?>
                                        <option value="<?php echo $get_kuliner['id']; ?>"><?php echo $get_kuliner['nama']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div> -->
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <a href="<?php echo base_url('admin/base_wisata') ?>" class="btn btn-success" type="submit">Back</a>
