<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 font-weight-bold text-primary">Data Kuliner</h1>
        <ol class="breadcrumb">
        ...
        <div id="form-add-list" class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Add Jenis Kuliner</h6>
                </div>
                <div class="card-body">
                    <form action="<?php echo base_url() ?>admin/jenis_kuliner/save" method="POST">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($jenis_kuliner as $jk) : ?>
                                <tr>
                                    <td><a href="#"><?= $no++; ?></a></td>
                                    <td><?= $jk['nama_jenis_kuliner']; ?></td>

                                    <!-- <td><a href="<?php echo base_url('admin/jenis_kuliner/detail/') . $jk['id'] ?>" class="btn btn-sm btn-success">Detail</a> -->
                                    <td><a href="<?php echo base_url('admin/jenis_kuliner/delete/') . $jk['id_jenis_kuliner'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                    </td>
                                </tr>
